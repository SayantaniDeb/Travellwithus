...
<span className='font-serif lg:font-bold lg:text-xl'>Your pocket friend travel kit,<br></br>plan your weekend with us!</span>   
  ...
  <div className="relative">
      ...
      <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Where do you wanna go?" required/>
